      ...
      <div className="max-w-[1400px] mx-auto">
        <header className="mb-12 md:mb-20 flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
            <div className="flex-1 min-w-0">
                <h1 className="text-4xl md:text-6xl font-black text-black uppercase tracking-tighter mb-4 italic leading-none break-words">MY ARCHIVES</h1>
                <div className="h-2 w-32 bg-blue-600 mb-6"></div>
                <p className="text-gray-400 font-bold uppercase tracking-[0.3em] text-[9px] md:text-[10px]">Your personal collection of hardware configurations.</p>
            </div>
            <Link 
                to="/builder"
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-24 md:py-40">
            ...
            <p className="text-[10px] font-black uppercase tracking-widest text-gray-400 italic">Accessing Personal Archives...</p>
          </div>
        ) : builds.length > 0 ? (
                  ...
                  <div key={build.id} className="group border-2 border-black bg-white hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all flex flex-col min-w-0">
                      ...
                      <div className="p-4 md:p-6 space-y-4 flex-1 flex flex-col min-w-0">
                          <div className="min-w-0">
                              <h3 className="text-base font-black text-black uppercase tracking-tight group-hover:text-blue-600 transition-colors mb-1 truncate">
                                  {build.title}
                              </h3>
                              <div className="flex items-center gap-2 text-[10px] font-black text-gray-400 uppercase tracking-widest truncate">
                          ...
                          <div className="mt-auto pt-4 border-t border-gray-100 flex justify-between items-center">
                              <span className="text-[10px] font-black text-gray-300 uppercase tracking-widest italic">STATUS: ARCHIVED</span>
                              <Link 
                                to={`/gallery/${build.id}`}
          ...
          <div className="mt-20 p-20 border-2 border-black border-dashed bg-gray-50 flex flex-col items-center justify-center text-center">
               ...
               <h2 className="text-xl font-black text-black uppercase tracking-[0.3em] mb-4">Archives Empty</h2>
               <p className="text-gray-400 text-xs font-bold uppercase max-w-sm leading-relaxed mb-8">
                  You haven't archived any hardware configurations yet. Start your first build to catalog it here.
               </p>
               <Link 
                to="/builder"
                className="bg-black text-white font-black py-4 px-10 uppercase tracking-widest text-xs hover:bg-blue-600 transition-colors shadow-[8px_8px_0px_0px_rgba(0,0,0,0.1)]"
               >
