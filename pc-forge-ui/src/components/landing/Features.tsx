      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-4 md:px-8">
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          <div className="flex-1 space-y-12">
            <div>
              <h2 className="text-3xl md:text-5xl font-black text-black uppercase tracking-tighter mb-6 leading-[0.9]">
                TECHNICAL <br /> SPECIFICATIONS
              </h2>
              <p className="text-base md:text-lg text-gray-600 max-w-lg leading-snug font-medium">
              ...
              {FEATURES.map((f, i) => (
                <div key={i} className="space-y-4 border-t border-black pt-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-black text-[11px] md:text-xs text-black uppercase tracking-[0.2em]">{f.title}</span>
                  </div>
                  <p className="text-[11px] text-gray-500 leading-relaxed font-bold uppercase">{f.desc}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="flex-1 w-full max-w-xl space-y-8">
            ...
            <div className="bg-white border-2 border-black p-10 shadow-[12px_12px_0px_0px_rgba(37,99,235,1)]">
                <div className="space-y-8">
                    <div className="space-y-2">
                        <div className="text-[10px] font-black uppercase text-gray-400">System Core Logic</div>
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="flex-1">
                            <div className="text-xs font-black uppercase mb-1">TDP Threshold</div>
                            <div className="h-2 bg-gray-100 w-full overflow-hidden">
            ...
            <div className="bg-white border-2 border-black p-10 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)]">
                <div className="space-y-8">
                    <div className="space-y-2">
                        <div className="text-[10px] font-black uppercase text-gray-400">Chassis Clearance</div>
                        <div className="h-px bg-black w-full opacity-10"></div>
                    </div>
                    <div className="flex items-center gap-6">
                        <div className="w-12 h-12 bg-blue-600 flex items-center justify-center text-white font-black text-xs">03</div>
                        <div className="flex-1">
                            <div className="text-xs font-black uppercase mb-1">GPU Length Check</div>
                            <div className="h-2 bg-gray-100 w-full overflow-hidden">
                    ...
                    <div className="flex items-center gap-6">
                        <div className="w-12 h-12 bg-gray-100 border border-black flex items-center justify-center text-black font-black text-xs">04</div>
                        <div className="flex-1">
                            <div className="text-xs font-black uppercase mb-1">PSU FORM FACTOR</div>
                            <div className="h-2 bg-gray-100 w-full overflow-hidden">
