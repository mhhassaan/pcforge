    ...
    <section className="py-24 bg-white border-b border-gray-100 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-4 md:px-8">
        <div className="max-w-2xl mb-16 border-l-4 border-blue-600 pl-6">
          <h2 className="text-3xl md:text-4xl font-bold text-black uppercase tracking-tighter mb-4">
            STOP THE GUESSWORK.
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          <div className="bg-gray-50 border-2 border-black p-8 rounded-none space-y-6 relative group">
            ...
            <div className="pt-4 flex gap-4 border-t border-red-100">
                ...
                <div className="space-y-1">
                    <h4 className="text-sm font-black text-black uppercase">SOCKET MISMATCH</h4>
          ...
          <div className="bg-gray-50 border-2 border-black p-8 rounded-none space-y-6 relative group shadow-[8px_8px_0px_0px_rgba(37,99,235,1)]">
            ...
            <div className="pt-4 flex gap-4 border-t border-blue-100">
                ...
                <div className="space-y-1">
                    <h4 className="text-sm font-black text-black uppercase">OPTIMAL READY</h4>
